...
#  add the line import random. This allows you to use functions from 
# the random module, like generating random numbers.
# Generate a secret number: Use random.randint(1, 10) to generate a 
# random number between 1 and 10 (you can adjust the range if you want). 
...
# If the guess is too low, display a message like 
# “Nope, your guess is a bit low. Give it another shot!”
# Offer to play again: Ask the user if they want to play again using 
# an if statement and user input.
# Bonus Challenge:
